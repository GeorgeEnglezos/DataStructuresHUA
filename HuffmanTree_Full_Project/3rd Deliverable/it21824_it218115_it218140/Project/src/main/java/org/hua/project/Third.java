...
public class Third {
    ...
    private static void makeCodesDatFile(ArrayList<HuffmanTree.code> arr) throws IOException {
        ...
        {
            out.println(arr.get(i).getC()+":"+arr.get(i).getCode()); //to print all the codes in separate lines
        }
